...
# the theoretical lectures
    ...
    # ====================== YOUR CODE HERE ======================
    cov_matrix = np.cov(iris_data_normalized, rowvar=False)
    # ============================================================
    ...
    if k==0:
       ...
       for i, (eigenvalue, _) in enumerate(eigen_pairs):
           explained_variance += eigenvalue
           if explained_variance / total_variance >= 0.95:
               k = i + 1
               break
    ...
    # ====================== YOUR CODE HERE ======================
    iris_data_redux = np.dot(iris_data_normalized, selected_eigenvectors.T)
    # ============================================================
