...
# -------------
    ...
    svm = svm.SVC(kernel=kernel_type, C=1)
    # Carry out the cross validation with the function cross_validate
    test_score = cross_validate(svm, X, y, scoring={'accuracy', 'f1'}, cv=K)
    # ============================================================
    ...
    # ====================== YOUR CODE HERE ======================
    accuracies_skl = test_score['test_accuracy']
    fscores_skl = test_score['test_f1']
