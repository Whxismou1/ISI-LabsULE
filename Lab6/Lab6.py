...
def calculate_cost_log_reg(y, y_hat):
    ...
    # ====================== YOUR CODE HERE ======================
    e = 10e-15
    cost_i = np.mean(-(y * np.log(y_hat + e) + (1 - y) * np.log(1 - y_hat + e)))
    # ============================================================
...
def train_logistic_regression(X_train, y_train, alpha_train,
    ...
    for num_iter in range(max_iter):
        ...
        # ====================== YOUR CODE HERE ======================
        theta_train -= alpha_train * (1 / m) * aux
        # ============================================================
        ...
        if abs(cost_values[num_iter] - cost_values[num_iter -1]) < 0.0005:
            cost_values = cost_values[:num_iter]
            break
        # ============================================================
...
if __name__ == "__main__":
    ...
    # Accuracy
    # ====================== YOUR CODE HERE ======================
    correctPredicts = np.diag(confm).sum()
    totalPredicts = confm.sum()
